...
public class ComposeForMySqlServiceSSLInfoCreator extends CloudFoundryServiceInfoCreator<MysqlServiceInfo> {
    ...
    public ComposeForMySqlServiceSSLInfoCreator() {
        super(new Tags(), MysqlServiceInfo.MYSQL_SCHEME);
    }
    ...
    public boolean accept(Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "compose-for-mysql".equals(label);
        }
        return result;
    }

    @Override
    public MysqlServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        String uri = null;
